    ...
    emailjs
      ...
      .then(
        (result) => {
          ...
          setStatusMessage("Message sent successfully!"); // Pesan sukses
          e.target.reset();
        },
        (error) => {
          console.log("FAILED...", error.text);
          setStatusMessage("Failed to send message. Please try again."); // Pesan gagal
        }
      )
      .finally(() => {
        setIsSubmitting(false);
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 justify-center">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:bagasggg6@gmail.com"
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4 justify-center">
                ...
                <a href="https://www.instagram.com/bagasxz.24" target="_blank">
                  <Instagram />
                </a>
                <a
                  href="https://www.facebook.com/bagas.septior"
                  target="_blank"
                >
                  <Facebook />
                </a>
